...
{
    Book* newBook = new Book (author_,isbn_,"book",prodName_,price_,qty_);
    return newBook;
}
...
{
    Clothing* newClothing = new Clothing (size_,brand_,"clothing",prodName_,price_,qty_);
    return newClothing;
}
...
{
    Movie* newMovie = new Movie (genre_,rating_,"movie",prodName_,price_,qty_);
    return newMovie;
